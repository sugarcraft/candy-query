...
use SugarCraft\Query\Admin\AsyncCachedConnection;
use SugarCraft\Query\Db\DatabaseInterface;
use SugarCraft\Query\Db\PreparedStatementInterface;

/**
 * Regression cover for AsyncCachedConnection's DatabaseInterface compatibility.
 *
 * AsyncCachedConnection::prepare() once declared `: mixed`, which is wider than the
 ...
 */
final class AsyncCachedConnectionTest extends TestCase
{
    public function testIsADatabaseInterface(): void
    {
        $conn = new AsyncCachedConnection(new FakeDatabase());
    ...
    public function testMetadataAccessorsDelegateToInner(): void
    {
        ...
        $conn = new AsyncCachedConnection($inner);
    ...
    public function testInjectedCacheServesQueriesWithoutTouchingTheGlobal(): void
    {
        ...
        try {
            ...
            $conn = new AsyncCachedConnection(new FakeDatabase(), $cache);
    ...
    public function testDefaultsToTheSharedCacheWhenNoneInjected(): void
    {
        ...
        try {
            ...
            $this->assertSame([['shared' => 'y']], (new AsyncCachedConnection(new FakeDatabase()))->query('SELECT 1'));
        } finally {
            AdminQueryCache::reset();
        }
    }
